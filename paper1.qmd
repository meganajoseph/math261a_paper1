...
library(readxl)
calenviroscreen <- read_excel("calenviroscreen40resultsdatadictionaryf2021/calenviroscreen40resultsdatadictionary_F_2021.xlsx")
...
The data is from CalEnviroScreen 4.0 which is a tool created by the Office of Environmental Health Hazard Assessment in the California Environmental Protection Agency used to help identify communities in California that are most affected by pollution [@Data]. It was last updated in 2021. The data used for the tool come from national and state sources.
